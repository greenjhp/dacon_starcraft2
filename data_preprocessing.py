...
train_final_ftr_df = train_final_ftr_df.drop(drop_column_list_2, axis='columns')
test_final_ftr_df = test_final_ftr_df.drop(drop_column_list_2, axis='columns')


## output
train_final_ftr_df.to_csv(os.path.join(output_folder,'train_final_ftr_0414_5.csv'), index=False)
test_final_ftr_df.to_csv(os.path.join(output_folder,'test_final_ftr_0414_5.csv'), index=False)
